...
const st = StyleSheet.create({
  ...
  inputRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.bg2, borderRadius: 14, borderWidth: 1, borderColor: colors.cardBorder, paddingHorizontal: 16, marginBottom: 16 },
  ...
  accChip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: colors.bg2, marginEnd: 8, borderWidth: 1.5, borderColor: 'transparent', gap: 6 },
  ...
  saveBtn: { flex: 1, flexDirection: 'row', paddingVertical: 14, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
