...
// Canonical default tree lives in src/config/categories.ts; re-exported
// because other modules import DEFAULT_GROUPS from this component.
export { DEFAULT_GROUPS } from '../config/categories';
