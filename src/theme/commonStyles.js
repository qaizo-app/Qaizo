...
export const fieldLabel = (overrides) => ({
...
export const textInput = (overrides) => ({
...
export const amountRow = (overrides) => ({
...
export const amountCurrency = (overrides) => ({
  fontSize: 32,
  fontWeight: '700',
  marginEnd: 8,
  ...overrides,
...
export const amountInput = (overrides) => ({
  flex: 1,
  color: colors.text,
  fontSize: 32,
  fontWeight: '700',
